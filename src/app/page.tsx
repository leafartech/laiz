  ...
  return (
    <div className="bg-zinc-100">
      <header className="sm:min-h-screen flex items-center justify-center pt-6 sm:pt-0 bg-gradient-to-b from-emerald-100 to-zinc-100">
        ...
        <div className="flex flex-col items-start sm:items-center gap-4 z-10 px-4 sm:px-0 py-12 sm:py-0">
          ...
          <div className="max-w-3xl text-center flex flex-col gap-6 items-center z-10">
            <h1 className="font-bold text-zinc-700 text-xl sm:text-2xl tracking-wide text-left sm:text-center">ASSISTA O VÍDEO ABAIXO PARA ENTENDER COMO UMA MUDANÇA NA SUA ALIMENTAÇÃO IRÁ TE <span className="text-emerald-500">PROPORCIONAR ENERGIA E EMAGRECIMENTO</span></h1>
      ...
      <main className="pt-0 sm:pt-12">
        <Section className="py-6 sm:py-12 px-4 sm:px-0">
          <div className="flex flex-col items-center gap-8">
            <div className="text-left sm:text-center max-w-2xl">
              <h2 className="text-xl sm:text-3xl text-zinc-950 font-bold mb-4">Para quem é?</h2>
              <p className="text-zinc-600 text-sm sm:text-lg mb-2">Este protocolo foi criado para pessoas que buscam ter uma transformação profunda na sensação de sentir-se bem e cheio de vida.</p>
              <p className="text-zinc-600 text-sm sm:text-lg">Você receberá todo meu acompanhamento - pessoal e de minha equipe - para nunca mais precisar tomar remédios.</p>
            </div>
        ...
        <Section className="py-6 sm:py-12 px-4 sm:px-0" classNameS="bg-zinc-600">
        ...
        <Section className="" classNameS="py-6 sm:py-12 my-6 sm:my-12 bg-zinc-600">
          <h2 className="text-xl sm:text-3xl font-bold text-left sm:text-center text-grad sm:max-w-4xl">A última “direção” que você precisará seguir na sua vida! Agende sua consulta para viver com energia e nunca mais depender de remédios.</h2>
        </Section>
        <Section className="py-6 sm:py-12 px-4 sm:px-0">
