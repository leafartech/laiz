        ...
        <Section className="py-6 sm:py-12 px-4 sm:px-0">
          <div className="flex flex-col items-center gap-3">
            <div className="text-left sm:text-center max-w-2xl">
              <h2 className="text-xl sm:text-3xl text-zinc-950 font-bold">Para quem é?</h2>
              <p className="text-zinc-600">Este protocolo foi criado para pessoas que buscam ter uma transformação profunda na sensação de sentir-se bem e cheio de vida.</p>
              <p className="text-zinc-600">Você receberá todo meu acompanhamento - pessoal e de minha equipe - para nunca mais precisar tomar remédios.</p>
            </div>
