...
export default function Map() {
    return (
        <div className="w-full max-w-5xl relative flex flex-col gap-6 lg:gap-6 mt-6 mb-4 lg:mb-12 lg:mt-16 px-2 lg:px-0">
            <img src="./images/v-2/lines.png" alt="" className="absolute mt-4 hidden lg:block" />
            <MapCard
                number="1"
                styles=""
