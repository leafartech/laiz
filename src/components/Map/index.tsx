...
export default function Map() {
    return (
        <div className="w-full max-w-5xl relative flex flex-col gap-12 sm:gap-32 mt-12 sm:mt-24 px-2 sm:px-0">
            <img src="./images/map.png" alt="" className="absolute hidden sm:block" />
            <MapCard
                number="1"
                styles=""
